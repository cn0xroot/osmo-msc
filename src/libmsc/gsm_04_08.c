...
/* Detect whether msg is a Location Updating Request, and if yes, return a pointer to the Classmark Type 1 information
...
static int msc_vlr_tx_common_id(void *msc_conn_ref)
{
	...
	return msc_a_nas_down(msc_a, MSC_ROLE_I, &msg);
}
