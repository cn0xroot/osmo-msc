...
int nas_a_decode_l2(struct nas_dec *nas_a, struct msgb *bssap);
...
int nas_a_bearer_cap_to_channel_type(struct gsm0808_channel_type *ct, const struct gsm_mncc_bearer_cap *bc);
